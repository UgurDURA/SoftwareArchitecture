...
class Demo
{
    public static void main(String[] args) {
        ...
        bf.filter(products, new AndSpecification<>(new ColorSpecification(Color.BLUE),new SizeSpecification(Size.LARGE))).forEach(p-> System.out.println("-"+p.name+" is Blue and Large"));
